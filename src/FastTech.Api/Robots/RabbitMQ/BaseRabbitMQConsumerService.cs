...
public abstract class BaseRabbitMQConsumerService : BackgroundService
{
    ...
    public BaseRabbitMQConsumerService(IServiceProvider serviceProvider, IOptions<FastTechSettings> option, ILogger logger, string exchange = null)
    {
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        consumer.Received += async (model, ea) =>
        {
            ...
            try
            {
                ...
                var service = scope.ServiceProvider.GetRequiredService<IItemCardapioApplicationService>();
                if (service != null)
                {
